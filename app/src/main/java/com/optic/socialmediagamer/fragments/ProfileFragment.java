        ...
        /*botontex.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Bitmap bitmap=barcodeEncoder.encodeBitmap("tel: " + mTextViewPhone.getText().toString(), BarcodeFormat.QR_CODE,  750, 750 );
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                if (queryDocumentSnapshots != null) {
                    ...
                    if (numberPost > 0) {
                        ...
                        try {
                            BarcodeEncoder barcodeEncoder = new BarcodeEncoder();
                            Bitmap bitmap=barcodeEncoder.encodeBitmap("Nombre de Usuario: " + mTextViewUsername.getText() + " tel: " + mTextViewPhone.getText().toString() + " Numero de publicaciones: " + mTextViewPostNumber.getText().toString(), BarcodeFormat.QR_CODE,  750, 750 );
                            codeqr.setImageBitmap(bitmap);
