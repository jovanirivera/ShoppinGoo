                ...
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("category")) {
                        ...
                        if (category.equals("VideoJuegos")) {
                            mImageViewCategory.setImageResource(R.drawable.ic_videogame);
                        }
                        else if (category.equals("Libros")) {
                            mImageViewCategory.setImageResource(R.drawable.ic_baseline_book_24);
                        }
                        else if (category.equals("Electronica")) {
                            mImageViewCategory.setImageResource(R.drawable.ic_baseline_tablet_24);
                        }
                        else if (category.equals("Motos")) {
                            mImageViewCategory.setImageResource(R.drawable.ic_baseline_sports_motorsports_24);
                        }
                    }
