...
import com.optic.socialmediagamer.fragments.MapsFragment;
import com.optic.socialmediagamer.fragments.ProfileFragment;
import com.optic.socialmediagamer.fragments.QrFragment;
    ...
    BottomNavigationView.OnNavigationItemSelectedListener navigationItemSelectedListener =
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                @Override public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    else if(item.getItemId()==R.id.itemQr){
                        openFragment(new QrFragment());
                    }
                    else if(item.getItemId()==R.id.itemMaps){
